...
import ru.sfedu.hibernatecoursezz.lab3.TablePerClass.api.HibernateProvider;
import ru.sfedu.hibernatecoursezz.lab3.TablePerClass.api.IHibernateProvider;
...
public class TPS {
    ...
    public static Logger log = LogManager.getLogger(TPS.class);
