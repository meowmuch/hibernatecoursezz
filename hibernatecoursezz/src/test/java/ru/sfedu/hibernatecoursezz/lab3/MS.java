...
import ru.sfedu.hibernatecoursezz.lab3.MappedSuperclass.api.HibernateProvider;
import ru.sfedu.hibernatecoursezz.lab3.MappedSuperclass.api.IHibernateProvider;
...
public class MS {
    ...
    public static Logger log = LogManager.getLogger(MS.class);
