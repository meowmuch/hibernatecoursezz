...
import ru.sfedu.hibernatecoursezz.lab3.JoinedTable.api.HibernateProvider;
import ru.sfedu.hibernatecoursezz.lab3.JoinedTable.api.IHibernateProvider;
...
public class JT {
    public static Logger log = LogManager.getLogger(JT.class);
