package ru.sfedu.hibernatecoursezz.lab3.SingleTable.api;
...
public class HibernateProvider implements IHibernateProvider {
    public static Logger log = LogManager.getLogger(ru.sfedu.hibernatecoursezz.lab3.SingleTable.api.HibernateProvider.class);
