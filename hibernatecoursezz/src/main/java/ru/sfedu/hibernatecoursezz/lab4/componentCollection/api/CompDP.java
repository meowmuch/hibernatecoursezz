...
import ru.sfedu.hibernatecoursezz.lab4.componentCollection.model.Client;
...
public class CompDP implements ICompDP {

    public static Logger log = LogManager.getLogger(CompDP.class);
    static Session session;

    @Override
    public ResultType updateClient(long id, String cname, String login, String password, List<Plan> plan) {
    ...
    @Override
    public Long createClient(String cname, String login, String password, List<Plan> plan) {
