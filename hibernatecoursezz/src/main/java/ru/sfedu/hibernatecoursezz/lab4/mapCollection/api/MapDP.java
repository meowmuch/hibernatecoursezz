...
public class MapDP implements IMapDP {
    public static Logger log = LogManager.getLogger(MapDP.class);
    static Session session;

    @Override
    public ResultType updateClient(long id, String cname, String login, String password, Map<String, String> comment) {
    ...
    @Override
    public Long createClient(String cname, String login, String password, Map<String, String> comment) {
